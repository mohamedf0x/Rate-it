const ar = {
  ...
  home: {
    ...
    heroEyebrow: "تقييمات حقيقية من ناس زيك",
    heroTitle: "اعرف المكان قبل ما تروحه",
    heroLede:
      "تقييمات للمحلات والمطاعم والملاعب — وللمنتج نفسه جوه المكان. اكتب رأيك، اكسب رُتبة، وساعد اللي جاي بعدك.",
    browseCta: "استكشف الأماكن",
    addCta: "أضف مكان",
    categoriesTitle: "دوّر حسب القسم",
    statsPlaces: "مكان",
    statsReviews: "تقييم",
    statsReviewers: "مراجع",
    coldStartTitle: "منطقتك لسه فاضية؟",
    coldStartBody:
      "أول واحد يضيف مكان وأول واحد يقيّمه بياخدوا نقاط زيادة. إضافة مكان بتاخد أقل من دقيقة.",
  },
  auth: {
    login: {
      title: "تسجيل الدخول",
